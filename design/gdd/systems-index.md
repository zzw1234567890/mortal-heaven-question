...
游戏系统覆盖五大循环阶段（开局、探索、战斗、养成、渡劫突破），包含222张卡牌的卡牌系统、5种流派方向、4大境界（炼气→筑基→金丹→元婴）以及跟随原著的章节式剧情。
...
| 8 | 卡牌效果解析引擎 | 玩法 (Gameplay) | MVP | 已设计 | card-effect-engine.md | 卡牌系统、绑定系统 |
...
| 类别 | 描述 | 典型系统 |
|----------|-------------|-----------------|
| **核心 (Core)** | 一切依赖的基础系统 | 游戏状态管理器、存档/读档、事件系统、行动力系统 |
